...
class TestDateRange {
    ...
    void testOverlapsTrue() {
    	...
    	boolean actual = dateRange1.overlaps(dateRange2);
    	boolean actual2 = dateRange2.overlaps(dateRange1);
    	assertTrue(actual);
    	assertTrue(actual2);
    	assertTrue(dateRange3.overlaps(dateRange3));
    }

    @Test
    void testOverlapsFalse() {
        // TODO: check we can see when two date ranges  don't overlap
     	boolean actual1 = dateRange2.overlaps(dateRange3);
     	assertFalse(actual1);
     	
     	boolean actual2 = dateRange3.overlaps(dateRange2);
     	assertFalse(actual2);
